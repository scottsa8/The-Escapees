        ...
        getCookie("username") == "Admin"?
            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    <h2 className="text-lg font-bold text-blue-900 dark:text-blue-100">Add Room</h2>
                ...
                <div className="space-y-2">
                    <h2 className="text-lg font-bold text-blue-900 dark:text-blue-100">Update Max Values</h2>
                ...
                <div className="space-y-2">
                    ...
                    <h2 className="text-lg font-bold text-blue-900 dark:text-blue-100">Update Microbit</h2>
